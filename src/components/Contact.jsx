    ...
    <section id="contact" className="section">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                <p className="text-white mt-3 mb-5 max-w-[50ch] lg:max-w-[50ch]">
                    Reach out today to discuss my qualifications and experience!
                </p>
                ...
                <div className="flex items-center">
                    {socialLinks.map(({ href, icon }, key) => (
                        ...
                        href={href}
                        target="_blank"
                        className="w-20 h-20 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg
                        transition-[background-color,color] hover:bg-zinc-100 hover:text-zinc-950 active:bg-zinc-50/80">
                            {icon}
                        </a>
                    ))}
                </div>
            ...
            <form
            action="https://getform.io/f/bnlldqvb"
            method="POST"
