    ...
    <section id="about" className="section">
        <div className="container">
            <div className="bg-zinc-800/50 p-7 rounded-2xl md:p-12">
                ...
                Nice to meet you! I am a software engineer with experience in building, maintaining, and testing software systems primarily using object-oriented languages.
